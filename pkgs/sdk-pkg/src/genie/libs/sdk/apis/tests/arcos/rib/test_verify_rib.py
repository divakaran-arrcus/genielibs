...
import inspect
import genie.libs.sdk.apis.arcos.rib.verify as verify_module
class _DummyDevice:
...
class TestRibVerifyCoverage(unittest.TestCase):
    """Machine-checked coverage: every public verify function in
    rib/verify.py must be referenced by name somewhere in this test
    ...
    def test_all_public_functions_covered(self):
        ...
        self.assertEqual(
            missing, [],
            f"Uncovered rib verify functions: {missing}")
