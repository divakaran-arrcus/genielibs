...
import inspect
import genie.libs.sdk.apis.arcos.interface.get as get_module
class _DummyDevice:
...
class TestInterfaceGetCoverage(unittest.TestCase):
    """Machine-checked coverage: every public get/is function in
    interface/get.py must be referenced by name somewhere in this test
    ...
    def test_all_public_functions_covered(self):
        ...
        self.assertEqual(
            missing, [],
            f"Uncovered interface get functions: {missing}")
